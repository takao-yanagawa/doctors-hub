...
export default function Home() {
  ...
  const handleDeclineOffer = (offer: Offer) => {
    ...
    console.log("INITIAL_AVAILABLE_DATES:", INITIAL_AVAILABLE_DATES);
    ...
    // この日付が元々空き日だったかどうかを INITIAL_AVAILABLE_DATES で確認
    // （availableDates の現在状態ではなく初期値で判定する）
    const wasAvailable = INITIAL_AVAILABLE_DATES.includes(offer.date);
    console.log("wasAvailable:", wasAvailable);
