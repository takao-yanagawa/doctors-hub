...
症例を受け取った時点で以下の条件が2つ以上すでに情報として与えられている場合：
・安静時呼吸困難あり
・SpO2 94%未満
・胸水貯留あり
・急速な体重増加（1週間で2kg以上）
...
最初の返答で必ず以下を行うこと：
1. 「入院管理が必要です」と最初に明示する
2. 鑑別疾患を述べる
3. 最も重要な1つだけ質問する（心電図を最初に聞くこと・2つ同時に聞かない）

正しい例：
「入院管理が必要です。急性心不全の増悪を最も疑いますが、急性冠症候群・肺血栓塞栓症・肺炎も除外が必要です。まず心電図は施行済みですか？」

禁止：
「心電図と胸部X線は撮影済みですか？」のように2つ同時に聞くこと`;
