...
const KEYWORD_MAP: [string, string][] = [
  ...
  ["急性心不全", "acute heart failure treatment"],
  ["心不全", "acute heart failure treatment"],
  ["フロセミド", "acute heart failure treatment"],
  ["利尿", "acute heart failure treatment"],
  ["ニトログリセリン", "nitroglycerin heart failure"],
  ["硝酸薬", "nitroglycerin heart failure"],
  ["市中肺炎", "community acquired pneumonia"],
  ["肺炎", "community acquired pneumonia"],
  ["レボフロキサシン", "levofloxacin pneumonia"],
  ["SpO2", "acute heart failure treatment"],
  ["酸素投与", "acute heart failure treatment"],
